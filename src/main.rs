...
use gcloud_sdk::{GoogleApi, google::cloud::secretmanager::v1::{secret_manager_service_client::SecretManagerServiceClient, ListSecretsRequest}, GoogleAuthMiddleware, GoogleEnvironment};
...
async fn vault(client: GoogleApi<SecretManagerServiceClient<GoogleAuthMiddleware>>) -> Result<(), Box<dyn std::error::Error>> {
